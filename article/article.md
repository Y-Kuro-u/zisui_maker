...
ただ、まだまだかなりのケースで想定外の動作をする場合があるので調整が必要かなと言う感覚です。  

やって感じてみた所感ですが画像処理も思ったより楽しいなという感じでした。  
今回触ってみたアルゴリズムは元記事にもあるとおりかなり初歩的な内容ながらもパラメータを自動で調整させたり汎用的にそれを作ろうとするとやはり難しいですね。  
