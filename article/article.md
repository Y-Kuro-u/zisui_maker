...
まぁ悪くはないんじゃないんでしょうか？  
実際にもっとこだわろうとすると、最後の回転だけではなく歪の補正なども必要になってくると思います。
ただ、まだまだかなりのケースで想定外の動作をする場合があるので調整が必要かなと言う感じですね。  

実際にやって感じてみた所感ですが画像処理も思ったより楽しいなという感じでした。  
ただ、今回触ってみたアルゴリズムは元記事にもあるとおりかなり初歩的な内容ではありますが、パラメータを自動で調整させたり汎用的にそれを作ろうとするとやはり難しいですね。  
